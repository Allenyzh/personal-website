...
This project is an internal survey system for **ITRI** (Industrial Technology Research Institute), designed to capture current digital/AI maturity across teams, collect reusable best practices, and identify high-impact priorities for the next phase of transformation.
